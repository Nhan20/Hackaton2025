...
Además, la información proveniente de los sensores alimenta un simulador predictivo que estima la probabilidad de inundación según la altura y las variables medidas, facilitando la toma de decisiones preventivas.
